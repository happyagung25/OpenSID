<p>
	<div id="siteTitle">
		...
		<h3>
			<?php echo $desa['alamat_kantor']?> <?php echo ucwords($this->setting->sebutan_kecamatan." ".$desa['nama_kecamatan'])?>&nbsp;
			<?php echo ucwords($this->setting->sebutan_kabupaten." ".$desa['nama_kabupaten'])?> <?php echo $desa['kode_pos']?><br />
